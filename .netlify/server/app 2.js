...
const Root = (0, import_index_cf0e86af.c)(($$result, $$props, $$bindings, slots) => {
  let { stores } = $$props;
  let { page } = $$props;
  ...
  (0, import_index_cf0e86af.s)("__svelte__", stores);
...
${components[1] ? `${(0, import_index_cf0e86af.v)(components[0] || import_index_cf0e86af.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {
    default: () => {
      return `${components[2] ? `${(0, import_index_cf0e86af.v)(components[1] || import_index_cf0e86af.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {
        default: () => {
          return `${(0, import_index_cf0e86af.v)(components[2] || import_index_cf0e86af.m, "svelte:component").$$render($$result, Object.assign(props_2 || {}), {}, {})}`;
        }
      })}` : `${(0, import_index_cf0e86af.v)(components[1] || import_index_cf0e86af.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {})}`}`;
    }
  })}` : `${(0, import_index_cf0e86af.v)(components[0] || import_index_cf0e86af.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {})}`}
...
let read = null;
(0, import_paths_6758d194.s)({ "base": "", "assets": "" });
...
function override(settings) {
  ...
  (0, import_paths_6758d194.s)(settings.paths);
...
class App {
  constructor(manifest) {
    ...
    this.options = {
      ...
      paths: { base: import_paths_6758d194.b, assets: import_paths_6758d194.a },
      prefix: import_paths_6758d194.a + "/_app/",
      prerender: true,
      read,
      root: Root,
      service_worker: null,
