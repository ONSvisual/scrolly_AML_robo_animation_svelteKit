...
function polygonContains(polygon, point) {
  ...
  var sum = new import_d3_array.Adder();
  if (sinPhi === 1)
    phi = halfPi + epsilon;
  else if (sinPhi === -1)
    phi = -halfPi - epsilon;
  ...
  return function(sink) {
    ...
    var clip2 = {
      ...
      polygonEnd: function() {
        ...
        segments = (0, import_d3_array.merge)(segments);
...
function clipRectangle(x02, y02, x12, y12) {
  ...
  return function(stream) {
    ...
    function polygonEnd() {
      var startInside = polygonInside(), cleanInside = clean && startInside, visible2 = (segments = (0, import_d3_array.merge)(segments)).length;
...
var identity = (x2) => x2;
var areaSum = new import_d3_array.Adder(), areaRingSum = new import_d3_array.Adder(), x00$2, y00$2, x0$3, y0$3;
var areaStream = {
  point: noop,
  lineStart: noop,
  lineEnd: noop,
  ...
  polygonEnd: function() {
    ...
    areaRingSum = new import_d3_array.Adder();
  },
  result: function() {
    var area = areaSum / 2;
    areaSum = new import_d3_array.Adder();
    return area;
  }
};
...
var lengthSum = new import_d3_array.Adder(), lengthRing, x00, y00, x0, y0;
var lengthStream = {
  point: noop,
  lineStart: function() {
  ...
  result: function() {
    ...
    lengthSum = new import_d3_array.Adder();
    return length;
  }
};
