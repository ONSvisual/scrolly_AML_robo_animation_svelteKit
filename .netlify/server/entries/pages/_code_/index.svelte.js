...
var import_archieml = __toESM(require("archieml"));
var import_d3_polygon = require("d3-polygon");
var import_svgpath = __toESM(require("svgpath"));
var import_svg_path_properties = require("svg-path-properties");
var import_earcut = require("earcut");
var import_topojson_client = require("topojson-client");
var import_d3_array = require("d3-array");
var import_d3_geo = require("d3-geo");
var import_topojson = require("topojson");
var import_d3_scale_chromatic = require("d3-scale-chromatic");
var import_d3_selection = require("d3-selection");
var import_line_intersect = require("line-intersect");
const getStores = () => {
...
<img src="${(0, import_index_cf0e86af.e)(import_paths_396f020f.a) + "/img/scroll-down-" + (0, import_index_cf0e86af.e)(color) + ".svg"}" class="${["arrow svelte-1prdo3z", animation ? "bounce" : ""].join(" ").trim()}" alt="${""}" aria-hidden="${"true"}">` : `<img src="${(0, import_index_cf0e86af.e)(import_paths_396f020f.a) + "/img/scroll-down-" + (0, import_index_cf0e86af.e)(color) + ".svg"}" class="${["arrow left svelte-1prdo3z", animation ? "bounce" : ""].join(" ").trim()}" alt="${""}" aria-hidden="${"true"}">${slots.default ? slots.default({}) : ``}`}`;
});
...
async function load({ params, fetch, session, stuff }) {
  const response = await fetch(`${import_paths_396f020f.a}/data/place_data/${params.code}.json`);
  test = params.code;
  a = await Promise.resolve().then(() => __toESM(require("../../../chunks/neighbours-25764e6a.js")));
  b = a.default;
  console.log("code", b);
...
const U5Bcodeu5D = (0, import_index_cf0e86af.c)(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    selected && console.log(`${import_paths_396f020f.b}/${selected}`);
