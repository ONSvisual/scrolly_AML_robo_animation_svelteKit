...
// src/lib/vis/animated_charts/node_modules/topojson/node_modules/topojson-client/src/identity.js
function identity_default(x) {
  return x;
}

// src/lib/vis/animated_charts/node_modules/topojson/node_modules/topojson-client/src/transform.js
...
// src/lib/vis/animated_charts/node_modules/topojson/node_modules/topojson-client/src/bbox.js
...
// src/lib/vis/animated_charts/node_modules/topojson/node_modules/topojson-client/src/reverse.js
...
// src/lib/vis/animated_charts/node_modules/topojson/node_modules/topojson-client/src/feature.js
...
// src/lib/vis/animated_charts/node_modules/topojson/node_modules/topojson-client/src/stitch.js
...
// src/lib/vis/animated_charts/node_modules/topojson/node_modules/topojson-client/src/mesh.js
...
function meshArcs(topology, object3, filter) {
  ...
  if (arguments.length > 1)
    arcs = extractArcs(topology, object3, filter);
  else
...
// src/lib/vis/animated_charts/node_modules/topojson/node_modules/topojson-client/src/merge.js
...
// src/lib/vis/animated_charts/node_modules/topojson/node_modules/topojson-client/src/bisect.js
...
// src/lib/vis/animated_charts/node_modules/topojson/node_modules/topojson-client/src/neighbors.js
...
// src/lib/vis/animated_charts/node_modules/topojson/node_modules/topojson-client/src/untransform.js
...
// src/lib/vis/animated_charts/node_modules/topojson/node_modules/topojson-client/src/quantize.js
...
// src/lib/vis/animated_charts/node_modules/topojson-server/src/bounds.js
...
// src/lib/vis/animated_charts/node_modules/topojson-server/src/hash/hashset.js
...
// src/lib/vis/animated_charts/node_modules/topojson-server/src/hash/hashmap.js
...
// src/lib/vis/animated_charts/node_modules/topojson-server/src/hash/point-equal.js
function point_equal_default(pointA, pointB) {
  return pointA[0] === pointB[0] && pointA[1] === pointB[1];
}

// src/lib/vis/animated_charts/node_modules/topojson-server/src/hash/point-hash.js
...
// src/lib/vis/animated_charts/node_modules/topojson-server/src/join.js
...
// src/lib/vis/animated_charts/node_modules/topojson-server/src/cut.js
...
// src/lib/vis/animated_charts/node_modules/topojson-server/src/dedup.js
...
// src/lib/vis/animated_charts/node_modules/topojson-server/src/delta.js
...
// src/lib/vis/animated_charts/node_modules/topojson-server/src/extract.js
...
// src/lib/vis/animated_charts/node_modules/topojson-server/src/geometry.js
...
// src/lib/vis/animated_charts/node_modules/topojson-server/src/prequantize.js
...
// src/lib/vis/animated_charts/node_modules/topojson-server/src/topology.js
...
// src/lib/vis/animated_charts/node_modules/topojson-simplify/src/prune.js
...
// src/lib/vis/animated_charts/node_modules/topojson-simplify/src/filter.js
...
// src/lib/vis/animated_charts/node_modules/topojson-simplify/src/filterAttached.js
...
// src/lib/vis/animated_charts/node_modules/topojson-client/src/identity.js
function identity_default2(x) {
  return x;
}

// src/lib/vis/animated_charts/node_modules/topojson-client/src/transform.js
...
// src/lib/vis/animated_charts/node_modules/topojson-client/src/reverse.js
function reverse_default2(array, n) {
  var t, j = array.length, i = j - n;
  while (i < --j)
    t = array[i], array[i++] = array[j], array[j] = t;
}

// src/lib/vis/animated_charts/node_modules/topojson-client/src/feature.js
...
function feature2(topology, o) {
  var id = o.id, bbox = o.bbox, properties = o.properties == null ? {} : o.properties, geometry = object2(topology, o);
  return id == null && bbox == null ? { type: "Feature", properties, geometry } : bbox == null ? { type: "Feature", id, properties, geometry } : { type: "Feature", id, bbox, properties, geometry };
}
...
// src/lib/vis/animated_charts/node_modules/topojson-simplify/src/planar.js
...
// src/lib/vis/animated_charts/node_modules/topojson-simplify/src/filterWeight.js
function filterWeight_default(topology, minWeight, weight) {
  minWeight = minWeight == null ? Number.MIN_VALUE : +minWeight;
  if (weight == null)
    weight = planarRingArea2;
  return function(ring, interior) {
    return weight(feature_default2(topology, { type: "Polygon", arcs: [ring] }).geometry.coordinates[0], interior) >= minWeight;
  };
}

// src/lib/vis/animated_charts/node_modules/topojson-simplify/src/filterAttachedWeight.js
...
// src/lib/vis/animated_charts/node_modules/topojson-simplify/src/heap.js
function compare(a, b) {
  return a[1][2] - b[1][2];
}
function heap_default() {
  var heap = {}, array = [], size = 0;
  heap.push = function(object3) {
    up(array[object3._ = size] = object3, size++);
    return size;
  };
  heap.pop = function() {
    if (size <= 0)
      return;
    var removed = array[0], object3;
    if (--size > 0)
      object3 = array[size], down(array[object3._ = 0] = object3, 0);
    return removed;
  };
  heap.remove = function(removed) {
    var i = removed._, object3;
    if (array[i] !== removed)
      return;
    if (i !== --size)
      object3 = array[size], (compare(object3, removed) < 0 ? up : down)(array[object3._ = i] = object3, i);
    return i;
  };
  function up(object3, i) {
    while (i > 0) {
      var j = (i + 1 >> 1) - 1, parent = array[j];
      if (compare(object3, parent) >= 0)
        break;
      array[parent._ = i] = parent;
      array[object3._ = i = j] = object3;
    }
  }
  function down(object3, i) {
    while (true) {
...
// src/lib/vis/animated_charts/node_modules/topojson-simplify/src/presimplify.js
function copy(point) {
  return [point[0], point[1], 0];
}
function presimplify_default(topology, weight) {
  var point = topology.transform ? transform_default2(topology.transform) : copy, heap = heap_default();
  if (weight == null)
...
// src/lib/vis/animated_charts/node_modules/topojson-simplify/src/quantile.js
...
// src/lib/vis/animated_charts/node_modules/topojson-simplify/src/simplify.js
...
// src/lib/vis/animated_charts/node_modules/topojson-simplify/src/spherical.js
var pi = Math.PI;
var tau = 2 * pi;
var quarterPi = pi / 4;
var radians = pi / 180;
