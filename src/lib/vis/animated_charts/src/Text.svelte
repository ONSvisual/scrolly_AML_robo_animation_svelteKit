...
<text class="titles" x={centroid[0]} y={centroid[1] + (20/$k)} text-anchor=middle font-size={15/$k} opacity={$label_opacity} style="pointer-events: none;" id={selected?"selectedValue":null}>
	{$value +" "+ $metric}
</text>
</g>